    ...
    <div className="min-h-screen p-4 sm:p-8 md:p-8 lg:p-10 font-[family-name:var(--font-inter)] bg-[#0A090C] text-white	">
      <main className="flex flex-col gap-6 md:gap-8 items-center justify-center dark:[color-scheme:light_dark]">
        ...
        <div className="w-full max-w-7xl mx-auto px-4 sm:px-6  ">
          <div className="grid gap-4 sm:gap-6 md:grid-cols-2 lg:grid-cols-3 lg:grid-rows-[100px_30px_20px_70px_20px_100px]">
            ...
            <Link
              ...
              className="bg-[#1D1D1D]/40 rounded-3xl p-4 sm:p-4 text-white flex flex-col gap-2 justify-between lg:col-span-1 lg:col-start-3 lg:row-start-1 lg:row-span-3 hover:scale-105 transition-all duration-300 ease-in-out"
            >
            ...
            <Link
              ...
              className="h-full lg:col-span-1 lg:col-start-3 lg:row-span-3 lg:row-start-4"
            >
            ...
            <Link
              href={'/contact'}
              className=" bg-[#1D1D1D]/40 rounded-3xl p-4 text-white lg:col-start-1 lg:col-span-1 lg:row-span-1 lg:row-start-6 flex items-center justify-center hover:scale-105 transition-all duration-300 ease-in-out"
            >
        ...
        <div className="projects-grid grid grid-cols-3  gap-8 w-full max-w-7xl mx-auto">
          <AnimatePresence>
