      ...
      <main className="flex flex-col gap-6 md:gap-8 items-center justify-center dark:[color-scheme:light_dark]">
        ...
        <div className="w-full max-w-7xl mx-auto px-4 sm:px-6  ">
          <div className="grid gap-4 sm:gap-6 md:grid-cols-2 lg:grid-cols-3 lg:grid-rows-[100px_30px_20px_70px_10px_100px]">
            ...
            <div className="bg-[#1D1D1D]/40 rounded-3xl p-4 sm:p-4 text-white lg:col-span-1 lg:col-start-3 lg:row-span-3 lg:row-start-4 hover:scale-105 transition-all duration-300 ease-in-out bg-[url('/thumbnails/kitchen.png')] bg-cover bg-center"></div>
