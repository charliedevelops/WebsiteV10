...
export const enum_blog_catagory = pgEnum('enum_blog_catagory', ['fx', 'develop', 'design'])
...
export const blog = pgTable(
  'blog',
  {
    ...
    Catagory: enum_blog_catagory('catagory'),
    updatedAt: timestamp('updated_at', { mode: 'string', withTimezone: true, precision: 3 })
      .defaultNow()
      .notNull(),
    createdAt: timestamp('created_at', { mode: 'string', withTimezone: true, precision: 3 })
...
export const relations_blog = relations(blog, () => ({}))
...
type DatabaseSchema = {
  enum_blog_catagory: typeof enum_blog_catagory
  users: typeof users
  media: typeof media
  blog: typeof blog
